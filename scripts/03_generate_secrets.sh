...
declare -A VARS_TO_GENERATE=(
    ...
    ["OPENCLAW_GATEWAY_PASSWORD"]="password:32" # OpenClaw gateway password for the local CLI and the password-login fallback ('openclaw security audit' warns under 24 chars)
